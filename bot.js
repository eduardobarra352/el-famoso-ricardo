...
bot.on("message", message => {
    ...
    if (cmd === `${prefix}desmotivacion`) {
      ...
      let args2 = message.content.slice(cmd.lenght).trim().split(args[1]);
      message.channel.startTyping();
